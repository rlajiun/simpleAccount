...
//        spinnerNames = new String[]{};
        spinnerNames = getResources().getStringArray(R.array.category_income);


        // 어댑터와 스피너를 연결합니다.
        CategoryAdapter categoryAdapter = new CategoryAdapter(SubActivity.this, spinnerNames, AddActivity.spinnerImages);
        ...
        spinner_cat.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(SubActivity.this, spinnerNames[selected_cat_idx], Toast.LENGTH_LONG).show();
            }
        ...
        btnincomeadd = findViewById(R.id.incomeAddButton);
        btnincomeadd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(editTextCost.getText().toString().length() !=0 ){
                    DBHelper dbHelper = new DBHelper(view.getContext(), "unvinDB",null, 1);
                    SQLiteDatabase db = dbHelper.getWritableDatabase();
                    db.execSQL(dbHelper.insertAccountSQL, new String[]{"0",editTextCost.getText().toString(), editTextDetail.getText().toString(),
                            datemsg+timemsg, String.valueOf(selected_cat_idx)});
                    db.close();
                    Toast.makeText(view.getContext(), "수입 추가되었습니다", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private void init() {
        ...
        date.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                DatePickerDialog dialog = new DatePickerDialog(SubActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
//                dialog.getDatePicker().setMaxDate(new Date().getTime());    //입력한 날짜 이후로 클릭 안되게 옵션
        ...
        time.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                TimePickerDialog dialog = new TimePickerDialog(SubActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
